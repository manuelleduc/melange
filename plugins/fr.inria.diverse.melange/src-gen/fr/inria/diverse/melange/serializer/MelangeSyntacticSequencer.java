...
public class MelangeSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_EcoreModelType_Element_ExternalLanguage_Language___RightCurlyBracketKeyword_1_1_p_or_RightCurlyBracketKeyword_8_1_p_or___ExternalKeyword_2_0_RightCurlyBracketKeyword_7_1_a____q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_EcoreModelType_Element_ExternalLanguage_Language___RightCurlyBracketKeyword_1_1_p_or_RightCurlyBracketKeyword_8_1_p_or___ExternalKeyword_2_0_RightCurlyBracketKeyword_7_1_a____q = new AlternativeAlias(false, true, new GroupAlias(false, false, new TokenAlias(false, false, grammarAccess.getElementAccess().getExternalKeyword_2_0()), new TokenAlias(true, true, grammarAccess.getExternalLanguageAccess().getRightCurlyBracketKeyword_7_1())), new TokenAlias(true, false, grammarAccess.getEcoreModelTypeAccess().getRightCurlyBracketKeyword_1_1()), new TokenAlias(true, false, grammarAccess.getLanguageAccess().getRightCurlyBracketKeyword_8_1()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if (match_EcoreModelType_Element_ExternalLanguage_Language___RightCurlyBracketKeyword_1_1_p_or_RightCurlyBracketKeyword_8_1_p_or___ExternalKeyword_2_0_RightCurlyBracketKeyword_7_1_a____q.equals(syntax))
				emit_EcoreModelType_Element_ExternalLanguage_Language___RightCurlyBracketKeyword_1_1_p_or_RightCurlyBracketKeyword_8_1_p_or___ExternalKeyword_2_0_RightCurlyBracketKeyword_7_1_a____q(semanticObject, getLastNavigableState(), syntaxNodes);
			...
			else if (match_ExternalLanguage_RightCurlyBracketKeyword_7_1_a.equals(syntax))
				emit_ExternalLanguage_RightCurlyBracketKeyword_7_1_a(semanticObject, getLastNavigableState(), syntaxNodes);
			else if (match_ExternalLanguage_RightCurlyBracketKeyword_7_1_p.equals(syntax))
	 ...
	 */
	protected void emit_EcoreModelType_Element_ExternalLanguage_Language___RightCurlyBracketKeyword_1_1_p_or_RightCurlyBracketKeyword_8_1_p_or___ExternalKeyword_2_0_RightCurlyBracketKeyword_7_1_a____q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) 'external' (ambiguity) 'ecl' ecl+=STRING
	 *     (rule start) 'external' (ambiguity) 'exactType' exactTypeName=ValidID
	 *     (rule start) 'external' (ambiguity) 'fileExtension' fileExtension=STRING
	 *     (rule start) 'external' (ambiguity) 'language' name=ValidID
	 *     (rule start) 'external' (ambiguity) 'sirius' sirius+=STRING
	 *     (rule start) 'external' (ambiguity) 'xmof' xmof=STRING
	 *     (rule start) 'external' (ambiguity) 'xtext' xtext+=STRING
	 *     (rule start) 'external' (ambiguity) operators+=Weave
	 ...
	 *     (rule start) (ambiguity) (rule start)
	 *     (rule start) (ambiguity) operators+=Weave
	 ...
	 *     ecl+=STRING (ambiguity) operators+=Weave
	 ...
	 *     fileExtension=STRING (ambiguity) operators+=Weave
	 *     operators+=ExternalImport (ambiguity) 'ecl' ecl+=STRING
	 *     operators+=ExternalImport (ambiguity) 'exactType' exactTypeName=ValidID
	 *     operators+=ExternalImport (ambiguity) 'fileExtension' fileExtension=STRING
	 *     operators+=ExternalImport (ambiguity) 'language' name=ValidID
	 *     operators+=ExternalImport (ambiguity) 'sirius' sirius+=STRING
	 *     operators+=ExternalImport (ambiguity) 'xmof' xmof=STRING
	 *     operators+=ExternalImport (ambiguity) 'xtext' xtext+=STRING
	 *     operators+=ExternalImport (ambiguity) (rule end)
	 *     operators+=ExternalImport (ambiguity) operators+=Weave
	 *     operators+=Weave (ambiguity) 'ecl' ecl+=STRING
	 *     operators+=Weave (ambiguity) 'exactType' exactTypeName=ValidID
	 *     operators+=Weave (ambiguity) 'fileExtension' fileExtension=STRING
	 *     operators+=Weave (ambiguity) 'language' name=ValidID
	 *     operators+=Weave (ambiguity) 'sirius' sirius+=STRING
	 *     operators+=Weave (ambiguity) 'xmof' xmof=STRING
	 *     operators+=Weave (ambiguity) 'xtext' xtext+=STRING
	 *     operators+=Weave (ambiguity) (rule end)
	 *     operators+=Weave (ambiguity) operators+=Weave
	 ...
	 *     sirius+=STRING (ambiguity) operators+=Weave
	 ...
	 *     xmof=STRING (ambiguity) operators+=Weave
	 ...
	 *     xtext+=STRING (ambiguity) operators+=Weave
	 */
	protected void emit_ExternalLanguage_RightCurlyBracketKeyword_7_1_a(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *     exactTypeName=ValidID (ambiguity) operators+=Weave
	 ...
	 *     exactTypeUri=STRING (ambiguity) operators+=Weave
	 */
	protected void emit_ExternalLanguage_RightCurlyBracketKeyword_7_1_p(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
