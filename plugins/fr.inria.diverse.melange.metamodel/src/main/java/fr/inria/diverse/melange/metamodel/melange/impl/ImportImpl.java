...
public class ImportImpl extends OperatorImpl implements Import {
	...
	public EList<PackageBinding> getMappingRules() {
		if (mappingRules == null) {
			mappingRules = new EObjectContainmentEList<PackageBinding>(PackageBinding.class, this, MelangePackage.IMPORT__MAPPING_RULES);
		}
		return mappingRules;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MelangePackage.IMPORT__MAPPING_RULES:
