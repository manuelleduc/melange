...
public class XbaseTransformationImpl extends TransformationImpl implements XbaseTransformation {
	...
	protected EClass eStaticClass() {
		return MelangePackage.Literals.XBASE_TRANSFORMATION;
	}
	...
	public NotificationChain basicSetBody(XExpression newBody, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MelangePackage.XBASE_TRANSFORMATION__BODY, oldBody, newBody);
	...
	public void setBody(XExpression newBody) {
		if (newBody != body) {
			...
			if (body != null)
				msgs = ((InternalEObject)body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MelangePackage.XBASE_TRANSFORMATION__BODY, null, msgs);
			if (newBody != null)
				msgs = ((InternalEObject)newBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MelangePackage.XBASE_TRANSFORMATION__BODY, null, msgs);
			msgs = basicSetBody(newBody, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MelangePackage.XBASE_TRANSFORMATION__BODY, newBody, newBody));
	}
	...
	public void setMain(boolean newMain) {
		...
		main = newMain;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MelangePackage.XBASE_TRANSFORMATION__MAIN, oldMain, main));
	}
	...
	public EList<JvmFormalParameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<JvmFormalParameter>(JvmFormalParameter.class, this, MelangePackage.XBASE_TRANSFORMATION__PARAMETERS);
		}
		return parameters;
	}
	...
	public NotificationChain basicSetReturnTypeRef(JvmTypeReference newReturnTypeRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MelangePackage.XBASE_TRANSFORMATION__RETURN_TYPE_REF, oldReturnTypeRef, newReturnTypeRef);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setReturnTypeRef(JvmTypeReference newReturnTypeRef) {
		if (newReturnTypeRef != returnTypeRef) {
			...
			if (returnTypeRef != null)
				msgs = ((InternalEObject)returnTypeRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MelangePackage.XBASE_TRANSFORMATION__RETURN_TYPE_REF, null, msgs);
			if (newReturnTypeRef != null)
				msgs = ((InternalEObject)newReturnTypeRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MelangePackage.XBASE_TRANSFORMATION__RETURN_TYPE_REF, null, msgs);
			msgs = basicSetReturnTypeRef(newReturnTypeRef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MelangePackage.XBASE_TRANSFORMATION__RETURN_TYPE_REF, newReturnTypeRef, newReturnTypeRef));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MelangePackage.XBASE_TRANSFORMATION__BODY:
				return basicSetBody(null, msgs);
			case MelangePackage.XBASE_TRANSFORMATION__PARAMETERS:
				return ((InternalEList<?>)getParameters()).basicRemove(otherEnd, msgs);
			case MelangePackage.XBASE_TRANSFORMATION__RETURN_TYPE_REF:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MelangePackage.XBASE_TRANSFORMATION__BODY:
				return getBody();
			case MelangePackage.XBASE_TRANSFORMATION__MAIN:
				return isMain();
			case MelangePackage.XBASE_TRANSFORMATION__PARAMETERS:
